...
graph TB
    ...
    Validation -->|Schema Validation| Raw_DB
    Validation -->|Anomaly Detection| Raw_DB
    ...
    DC -.->|Data Quality Feedback| Validation
    Error -->|Data Errors| Validation & DW & DC
    Error -->|Model Errors| ML & IA
    ...
    Monitor -->|Performance Metrics| SA
